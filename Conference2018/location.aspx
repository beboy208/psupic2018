        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="container">
                    <br>
                    <ul>
                        <li> <strong>Hotel Name:  PSU LODGE</strong> </li>
                        <p> PSU Lodge is a limited service hotel and it came from the University’s idea which aims to facilitate the customers by offering clean and safe rooms especially the price is affordable. The lodge is restfully located in the heart of Kathu district and suitable place to stay.</p>
                           ...
                           <table>
                               <tr><td><strong>Hotel Contact: </strong></td>
                                   <td>Tel +(66) 76 276 300</td>
                               </tr>
                               <tr><td></td><td>E-mail: <a href="mailto:psulodge@gmail.com">psulodge@gmail.com</a></td></tr>
                               <tr><td></td><td>Facebook:  <a href="http://www.facebook.com/psulodge">www. facebook.com/psulodge</a></td></tr>
                            </table>
                        ...
                        <br>
                        <li> <strong>Hotel Name:  PEARL HOTEL</strong>  </li>
                        <p>Welcome to Pearl Hotel, the original and exclusive city hotel in the heart of Phuket Town center.
Discover an extraordinary interior decoration like no others in Phuket island with endless counts of shells and pearl shells, giving a unique theme to this fabulous city hotel.
                           ...
                           <p><strong>Hotel Contact:</strong></p>
                              <p>Tel +(66) 76 211 044 </p>
                           <p>Fax +(66) 76 212 911 </p>
                           <p>E-mail: <a href="mailto:info@pearlhotel.co.th">info@pearlhotel.co.th</a> </p>
                           <p>Website: <a href="http://www.pearlhotel.co.th"> www. pearlhotel.co.th</a> </p>

                            <p><strong>Roomrate</strong></p>
                            <p>Pearl Room  1,500 THB /night/room  * Inclusive of Breakfast</p>
                        <br>
                        <li><strong>Hotel Name:  ARECA RESORT & SPA</strong>   
                           ...
                           <table>
                               ...
                               <tr><td></td><td>Fax +(66) 76 319 017</td></tr>
                               <tr><td></td><td>Website:  <a href="http://www.arecaresort.com">www. arecaresort.com</a></td></tr>
                            </table>

                            <p><strong>Roomrate</strong></p>
                            <table width="80%"  >
  <tr>
    <td width="30%" rowspan="2">Deluxe Room  (single /double)</td>
    <td width="80%">2,200 THB /night/room  * Inclusive of  Breakfast</td>
  </tr>
  <tr>
